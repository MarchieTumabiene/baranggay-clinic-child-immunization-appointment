                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="d-flex gap-2">
                                            ...
                                            <a href="admin/view-record.php?id=<?= $row['id'] ?>" class="btn btn-primary d-flex align-items-center justify-content-between" style="width: 80px;"><i class="fa fa-file-lines"></i> View</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
