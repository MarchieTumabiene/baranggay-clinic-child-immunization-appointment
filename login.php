        ...
        <div class="card rounded-0 shadow bg-transparent" style="width: 500px; backdrop-filter: blur(3px);">
            <div class="card-body p-3 text-light">
                ...
                <form action="?login" method="post">
                    ...
                    <p><input type="checkbox" required name="terms" class="form-check-input me-2 text-light">  <a href="https://www.madridejosbarangayimmunization.com/assets/pdf/Terms-And-Conditions.pdf" target="_blank" rel="noopener noreferrer">Terms and Condition</a></p>
            ...
            <a href="activate-admin.php" class="mx-auto text-decoration-none">Login as Admin</a>
            </div>
